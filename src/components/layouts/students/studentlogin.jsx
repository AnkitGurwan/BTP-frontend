    ...
    return (
        <div className="flex justify-center mx-4 mt-8 md:mt-0">
            <div className='w-full md:w-1/3 mx-auto shadow-lg flex flex-col items-center justify-center p-4'>
                <div className="text-lg md:text-xl" style={{'fontFamily':'Manrope','fontWeight':'900'}}>Click on Login to continue</div>
                <br/>
                <div className="w-full flex justify-center p-1 md:p-3">
                    <button
                        id="myButton"
                        className="bsk-btn w-2/3 flex justify-center items-center p-1 md:p-2 rounded bsk-btn-default bg-green-600 hover:bg-green-700 text-white "
