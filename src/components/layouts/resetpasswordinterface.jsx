                ...
                <div class="tab-pane fade show active" id="pills-login" role="tabpanel" aria-labelledby="tab-login" >
                    <form className='formcreateaccount flex flex-col justify-center' onSubmit={submit}  >
                        <div class="form-outline mb-2" className="proflogininput">
                            <input className='form-control' onKeyUp={validate_password} type='password' name='password' value={user.password} placeholder="New Password" required autoFocus onChange={detectChanges} style={{"width":"100%"}}/>
                        </div>
